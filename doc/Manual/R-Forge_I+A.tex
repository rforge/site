...
\fboxrule=0.2mm
\noindent \fcolorbox{black}{light-gray}{\code{/etc/apt/sources.list}}
\medskip	
...
\code {deb http://fusionforge.fusionforge.org/debian lenny main}
...
\definecolor{light-gray}{gray}{0.95}	
\fboxrule=0.2mm
\noindent \fcolorbox{black}{light-gray}{\code{gpg --recv-keys
    06F90DE5381BA480}}
\medskip
...
\definecolor{light-gray}{gray}{0.95}	
\fboxrule=0.2mm
\noindent \fcolorbox{black}{light-gray}{\code{gpg --export --armor
    06F90DE5381BA480 | sudo apt-key add -}}
\medskip
...
\definecolor{light-gray}{gray}{0.95}	
\fboxrule=0.2mm
\noindent \fcolorbox{black}{light-gray}{\code{aptitude install
    subversion joe}}
{\code{emacs ess r-base r-recommended bzip rsync less}}
\medskip
...
\definecolor{light-gray}{gray}{0.95}	
\fboxrule=0.2mm
\noindent \fcolorbox{black}{light-gray}{\code{~\$ mkdir svn cd svn svn co svn://svn-statmath.wu.ac.at/radmin radmin}}
\medskip
...
Optopnal * homeverzeichnis nach /srv linken
