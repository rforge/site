...
\begin{figure*}[th]
\centering
\includegraphics{rforge_main_snapshot.png}
\caption{Home page of \R{}-Forge on 2009-03-06}
\label{fig:home_page}
\end{figure*}
...
the personal page of one of the authors.

\setkeys{Gin}{width=0.95\textwidth}
\begin{figure*}[th]
\centering
\includegraphics{rforge_my_page_snapshot.png}
\caption{A \tab{My Page} tab of a registered user}
\label{fig:my_page}
\end{figure*}
...
Page} tab and clicking on \tab{Register Project}~(see
...
necessarily reflect the latest revision committed to the SVN. 

Figure~\ref{fig:rpackages_tab} shows the top part of the \tab{R
  Packages} tab of the Rglpk project as one of the project
...
\begin{figure*}[th]
\centering
\includegraphics{rforge_rglpk_packages_snapshot_developer.png}
\caption{\tab{R Packages} tab of the Rglpk project}
...
\item a re-organized tracker more compatible to \R{} package
  development and,
