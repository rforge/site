...
Many package developers use similar 
infrastructure to manage their source code. They have their own private
SVN repositories or use third party like Google Code
(\url{http://code.google.com}). Moreover, around $45%$ of
the packages on CRAN have 2 or more authors (as of June 02, 2008). All
of the above show that a central repository would help people to
develop R packages.
