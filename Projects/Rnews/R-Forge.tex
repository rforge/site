...
%%distributed all around the world was the increasing penetration of the
%%internet. 

%%Leveraging this media, online communities have formed and
%%now their
%%members successfully combine not only their programming effort but
%%also their knowledge and even share their social life. 

%%OSS is by definition free and the source code is available to
%%everyone. Within such framework source code is evolving fast not only
%%due to the ``release early, release often'' paradigm introduced by
%%Linus Torvalds---the founder of the Linux operating
%%system. \cite{forge:Raymond:1999} compared the open source model to a
%%bazaar . A couple of
%%other reasons  are the cornerstones
%%of the success of open source 

%%are the key ingredients for the success of OSS
%%R-core team members are distributed all around the world and rarely
