...
\tab{R Packages} tab, but Senior Developers additionally have
...
specific statistics) another tab named \tab{My Page} leads registered
...
Figure~\ref{fig:rpackages_tab} shows the top part of the \tab{R
  Packages} tab of the Rmetrics project as one of the project
...
\begin{figure*}[th]
\centering
\includegraphics{rforge_rmetrics_packages_snapshot_developer.png}
\caption{\tab{R Packages} tab of the Rmetrics project}
