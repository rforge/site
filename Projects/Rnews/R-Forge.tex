...
Therefore, many web-based (??) tools emerged that assist a collaborative software
...
\code{foo} the repository is located at
\code{svn://svn.R-Forge.R-project.org/svnroot/foo}. From
...
Furthermore, aeta-information about a project can be supplied in
